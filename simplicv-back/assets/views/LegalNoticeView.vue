<template>
  <div class="mb-12">
    <div>
      <h1 class="text-3xl sm:text-4xl md:text-5xl text-center gap-5 text-blue pt-6  pb-6 sm:pb-9">Mentions légales</h1>
    </div>
    <div class="container mx-auto px-3">
      <p style="text-align: justify">
        ...
        visiteurs du site :
        <a href="http://simplicv.fr" target="_blank">simplicv.fr</a> les
        informations suivantes :
      </p>

      <p class="mt-3 text-md sm:text-lg text-blue" style="text-align: justify"><strong>ÉDITEUR</strong></p>

      <p style="text-align: justify">
        Le site
        <a
          href="http://simplicv.fr"
          style="
            color: rgb(7, 130, 193);
          ...
          target="_blank"
          >simplicv.fr</a
        > est la propriété exclusive de <strong>Association </strong
        ><strong>Aide Emploi</strong>, qui l'édite.
      </p>

      <p style="text-align: justify">
        <strong>Aide Emploi</strong><strong> </strong><br />
        <strong>Association </strong>au capital de<strong> </strong
        ><strong>10 000 euros </strong>€Tél  : <strong>0654546023</strong>
      </p>

      <p style="text-align: justify">
        <strong>2 rue de l'entraide </strong><strong>33300 Bordeaux</strong
        ><br />
        Immatriculée au Registre du Commerce et des Sociétés de  <strong
          >Bordeaux 123 456 789 </strong
        >sous le numéro<strong> </strong><strong>123 456 789 00001</strong
        ><strong> </strong>
      </p>

      <p style="text-align: justify">
        Numéro TVA intracommunautaire : <strong>FR12345678901</strong><br />
        Adresse de courrier électronique :
        <strong>contact@aideemploi.fr</strong> <br />
         <br />
        Directeur de la  publication : <strong>Aide Emploi </strong><br />
        Contactez le responsable de la publication :
        <strong>contact@aideemploi.fr</strong>
      </p>

      <p style="text-align: justify"> </p>

      <p class="my-3 text-md sm:text-lg text-blue" style="text-align: justify"><strong>HÉBERGEMENT</strong></p>

      <p style="text-align: justify">
        Le site est hébergé par <strong
          >O2switch CHE DES PARDIAUX 63000 CLERMONT-FERRAND</strong
        ><br />
        <u><strong>CREDITS :</strong></u> les mentions légales ont étés générées
        par
        <strong
      ...
      <p class="my-3 text-md sm:text-lg text-blue" style="text-align: justify">
        <strong>DESCRIPTION DES SERVICES FOURNIS</strong>
      </p>

      <p style="text-align: justify">
        Le site
        <a href="http://simplicv.fr" class="mt-3 text-md sm:text-lg text-blue" style="text-align: justify" target="_blank"
          >simplicv.fr</a
        >
        ...
        susceptibles d’évoluer. Elles sont données sous réserve de modifications
        ayant été apportées depuis leur mise en ligne.  
      </p>

      <p class="my-3 text-md sm:text-lg text-blue"><strong>PROPRIÉTÉ INTELLECTUELLE ET CONTREFAÇONS</strong></p>
      ...
      <p>
        ...
        sauf autorisation écrite préalable à l'email : contact@aideemploi.fr  .
      ...
      <p class="my-3 text-md sm:text-lg text-blue" ><strong>LIENS HYPERTEXTES ET COOKIES</strong></p>
      ...
      <p>
        ...
        <a href="http://simplicv.fr" class="mt-3 text-md sm:text-lg text-blue" style="text-align: justify" target="_blank"
          >simplicv.fr</a
        >, un ou des cookies sont susceptible de s’installer automatiquement sur
        son ordinateur. Un cookie est un fichier de petite taille, qui ne permet
        ...
        d’informer de la présence de cookie et éventuellement, de refuser de la
        manière décrite à l’adresse suivante : www.cnil.fr Le refus
      ...
      <p class="my-3 text-md sm:text-lg text-blue">
        <strong
      ...
      <p>
        ...
        <a href="http://simplicv.fr" class="text-md sm:text-lg text-blue" style="text-align: justify" target="_blank"
          >simplicv.fr</a
        >
      ...
      <p>
        ...
        de la même obligation de conservation et de modification des données vis
      ...
      <p>
        ...
        <a href="simplicv.fr/mentions-legales">simplicv.fr/mentions-legales</a>.
      </p>
