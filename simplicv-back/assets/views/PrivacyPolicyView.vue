<template>
  <div class="mb-12">
    <h1 class="text-3xl sm:text-4xl md:text-5xl text-center gap-5 text-blue pt-6  pb-6 sm:pb-9">Politique de confidentialité</h1>
    <div class="container mx-auto px-3">
      <div>
        <p>
          Le site web SimpliCV est détenu par Aide emploi, qui est un contrôleur
          de données de vos données personnelles.
        </p>
        <p>
          Nous avons adopté cette politique de confidentialité, qui détermine la
          manière dont nous traitons les informations collectées par SimpliCV,
          ...
          d'utiliser le site web de SimpliCV.
        </p>
        <p>
      ...
      <div>
        <h2 class="mt-3 text-md sm:text-lg text-blue">Les informations personnelles que nous collectons :</h2>
        <p>
          Lorsque vous visitez le SimpliCV, nous recueillons automatiquement
      ...
      <div>
        <h2 class="mt-3 text-md sm:text-lg text-blue">Pourquoi traitons-nous vos données ?</h2>
        <p>
      ...
      <div>
        <p>
          ...
          via contact@aideemploi.fr.
        </p>
      </div>

      <div>
        <h2 class="mt-3 text-md sm:text-lg text-blue">Vos droits :</h2>
        <p>
        ...
        <p>Le droit d'accès.</p>
        <p>Le droit de rectification.</p>
        <p>Le droit à l'effacement.</p>
        <p>Le droit de restreindre le traitement.</p>
        ...
        <div>
          <h2 class="mt-3 text-md sm:text-lg text-blue">Liens vers d'autres sites web :</h2>
          <p>
        ...
        <div>
          <h2 class="mt-3 text-md sm:text-lg text-blue">Sécurité de l'information :</h2>
          <p>
        ...
        <div>
          <h2 class="mt-3 text-md sm:text-lg text-blue">Divulgation légale :</h2>
          <p>
        ...
        <div>
          <h2 class="mt-3 text-md sm:text-lg text-blue">Informations de contact :</h2>
          <p>
