<template>
  <div class="cv-models container mx-auto px-3 py-4 md:px-8 md:py-8 pb-12">
    <div
      class="whitespace-nowrap progress-bar list-none flex items-start sm:justify-center sm:items-center gap-4 pt-3 pb-8 sm:pt-12 md:pt-8 sm:pb-12 text-lg md:text-xl"
    >
      <li
      ...
      >
        1. Choississez votre template <i class="fa-solid fa-chevron-right"></i>
      </li>
      <li
        :class="{
        ...
        class="cursor-pointer"
      >
        2. Entrez vos informations <i class="fa-solid fa-chevron-right"></i>
      </li>
      <li
